defmodule OorjaBeamWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule OorjaBeam.MyChannel do
        use OorjaBeamWeb, :channel
        alias OorjaBeam.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :oorja_beam,
                        pubsub_server: OorjaBeam.PubSub
end
